...
package com.palmap.BluetoothUtils.widget.widget;
...
import com.palmap.BluetoothUtils.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0x00111111,
